...
+ (void)clearCache {
    [[ChineseToPinyinResource getInstance] clearCache];
}
...
+ (void)toHanyuPinyinStringWithSourceString:(NSString *)str
            withPinyinFormat:(HanyuPinyinOutputFormat *)outputFormat
                           bySeperator:(NSString *)seperater
                            handleResult:(OutputStringBlock)outputBlock
{
...
+ (NSString *)toHanyuPinyinStringWithSourceString:(NSString *)str withPinyinFormat:(HanyuPinyinOutputFormat *)outputFormat bySeperator:(NSString *)seperater {
